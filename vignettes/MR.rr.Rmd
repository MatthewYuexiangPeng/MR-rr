...
We see that when the IV strength is about 1.5, the MR-rr estimator with regularization has a smaller bias and standard deviation comparing to the naive MR-rr estimator.
